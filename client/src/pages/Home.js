...
function Home() {
  return (
    <div>
      <Header/>
      <div className="introduction flex-width-center"style={{ background: `url(./bg.svg)` }}>
        <div>
          <h1>Tomasz</h1>
      ...
      <div className="container">
        ...
        <div className="row pt-5 justify-content-center">
          <div className="col-md-4">
            <div>
              <img src='./jsbuff.svg' alt='imaggeeee' height="200" className="w-100"/>
            </div>
          </div>
        </div>
